...
public class LandscapeDisplay {
    ...
    public LandscapeDisplay(Board scape, int scale) {
        ...
        // extension for reset button
        b = new JButton("Reset");
        b.setPreferredSize(new Dimension(100, 30));
        b.setBounds(600, 400, 100, 100);
        b.setForeground(Color.BLUE);
        win.add(b);
        b.setVisible(true);

        // extension for solve button
        c = new JButton("Solve");
        c.setPreferredSize(new Dimension(100, 30));
        c.setBounds(600, 200, 100, 100);
    ...
    public JFrame winGet() { // returns jFrame win
        return win;
    }

    public JButton bGet() { // returns jButton b
        return b;
    }

    public JButton cGet() { // returns jButton c
        return c;
    }
